...
void (async () => {
  ...
  try {
    ...
    await page.pdf({ path: 'D:/page1.pdf', displayHeaderFooter: true, headerTemplate: '<div style="font-size: 20px;"><div>测试</div><div>测试</div><div>测试</div><div>测试</div><div>测试</div></div>',
    footerTemplate: '<div style="font-size: 20px;"><div>测试</div><div>测试</div><div>测试</div><div>测试</div><div>测试</div></div>'})
