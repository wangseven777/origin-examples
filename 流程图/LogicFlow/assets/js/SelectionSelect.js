  ...
  return (function (t) {
    ...
    function (t, n, e) {
      ...
      t.exports = function (t) {
        if (!i(f, t) || (!u && "string" != typeof f[t])) {
          var n = "Symbol." + t;
          u && i(s, t) ? (f[t] = s[t]) : (f[t] = a && l ? l(n) : p(n));
        }
        return f[t];
      };
    },
    ...
    function (t, n, e) {
      ...
      (t.exports = function (t, n, e, a) {
        ...
        o(e) &&
          ...
          (!i(e, "name") || (s && e.name !== y)) && c(e, "name", y),
          (f = p(e)).source ||
            (f.source = v.join("string" == typeof y ? y : ""))),
          t !== r
            ? (l ? !h && t[n] && (d = !0) : delete t[n],
              d ? (t[n] = e) : c(t, n, e))
            : d
            ? (t[n] = e)
            : u(n, e);
    ...
    function (t, n, e) {
      ...
      if (c || p.state) {
        var m = p.state || (p.state = new y()),
          ...
          x = a(m.set);
        (r = function (t, n) {
          if (g(m, t)) throw new h("Object already initialized");
          return (n.facade = t), x(m, t, n), n;
        }),
          (o = function (t) {
            return b(m, t) || {};
          }),
        ...
        (d[S] = !0),
          (r = function (t, n) {
            if (l(t, S)) throw new h("Object already initialized");
          ...
          return function (d, h, y, m) {
            for (
              var b,
                ...
                j = 0,
                E = m || a,
                P = n ? E(d, O) : e || p ? E(d, 0) : void 0;
              O > j;
              j++
            )
              if ((v || j in S) && ((g = w((b = S[j]), j, x)), t))
                if (n) P[j] = g;
                else if (g)
                  switch (t) {
                    case 3:
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n) {
        ...
        for (; n.length > f; ) o(r, (e = n[f++])) && (~c(s, e) || a(s, e));
        return s;
      };
    },
    function (t, n) {
    ...
    function (t, n, e) {
      "use strict";
      e.r(n),
        e.d(n, "SelectionSelect", function () {
          return i;
        });
      e(94), e(60), e(95), e(68);
      function r(t, n) {
      ...
      var i = (function () {
        function t(n) {
          ...
          !(function (t, n) {
            ...
            o(this, "__disabled", !1),
            o(this, "isDefaultStopMoveGraph", !1),
            o(this, "isWholeNode", !0),
            o(this, "isWholeEdge", !0),
            o(this, "__draw", function (t) {
              var n = e.lf.getPointByClient(
                  t.clientX,
                  t.clientY
                ).domOverlayPosition,
                r = n.x,
              ...
              r < c && ((f = r), (l = c - r)),
                ...
                (a.top = "".concat(s, "px")),
                (a.width = "".concat(l, "px")),
                (a.height = "".concat(p, "px"));
            }),
            o(this, "__drawOff", function () {
              document.removeEventListener("mousemove", e.__draw),
                document.removeEventListener("mouseup", e.__drawOff),
                (e.wrapper.oncontextmenu = null),
                e.__domContainer.removeChild(e.wrapper);
              var t = e.startPoint,
                n = t.x,
                r = t.y,
                o = e.endPoint,
                i = o.x,
                c = o.y;
              if (!(Math.abs(i - n) < 10 && Math.abs(c - r) < 10)) {
                var u = [Math.min(n, i), Math.min(r, c)],
                  a = [Math.max(n, i), Math.max(r, c)],
                  f = e.lf.graphModel.getAreaElement(
                    u,
                    a,
                    e.isWholeEdge,
                    e.isWholeNode,
                  ...
                  s = e.lf.graphModel.group;
                f.forEach(function (t) {
                  (s && s.getNodeGroup(t.id)) ||
                    e.lf.selectElementById(t.id, !0);
                }),
                  e.lf.emit("selection:selected", f);
              }
            }),
            (this.lf = r);
          var i = r.getEditConfig().stopMoveGraph;
          (this.isDefaultStopMoveGraph = i),
            (r.openSelectionSelect = function () {
              e.openSelectionSelect();
            }),
            (r.closeSelectionSelect = function () {
          ...
          (e = [
            {
              ...
              value: function (t, n) {
                var e = this;
                (this.__domContainer = n),
                  t.on("blank:mousedown", function (r) {
                    var o = r.e;
                    if (
                      t.getEditConfig().stopMoveGraph &&
                      !e.__disabled &&
                      2 !== o.button
                    ) {
                      var i = t.getPointByClient(
                          o.clientX,
                          o.clientY
                        ).domOverlayPosition,
                        c = i.x,
                        u = i.y;
                      (e.startPoint = { x: c, y: u }),
                        (e.endPoint = { x: c, y: u });
                      var a = document.createElement("div");
                      (a.className = "lf-selection-select"),
                        (a.oncontextmenu = function (t) {
                          t.preventDefault();
                        }),
                        (a.style.top = "".concat(e.startPoint.y, "px")),
                        (a.style.left = "".concat(e.startPoint.x, "px")),
                        n.appendChild(a),
                        (e.wrapper = a),
                        document.addEventListener("mousemove", e.__draw),
                        document.addEventListener("mouseup", e.__drawOff);
                    }
                  });
              },
            },
            {
              key: "setSelectionSense",
              value: function () {
                var t =
                  ...
                  n =
                    ...
                    arguments[1];
                (this.isWholeEdge = t), (this.isWholeNode = n);
              },
            },
            {
              key: "openSelectionSelect",
              value: function () {
                this.lf.getEditConfig().stopMoveGraph ||
                  ((this.isDefaultStopMoveGraph = !1),
                  this.lf.updateEditConfig({ stopMoveGraph: !0 })),
                  this.open();
              },
            },
            {
              key: "closeSelectionSelect",
              value: function () {
                this.isDefaultStopMoveGraph ||
                  this.lf.updateEditConfig({ stopMoveGraph: !1 }),
                  this.close();
              },
            },
            {
      ...
      o(i, "pluginName", "selectionSelect");
    },
  ]);
});
