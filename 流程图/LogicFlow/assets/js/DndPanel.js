          ...
          return function (d, h, y, m) {
            for (
              var b,
                ...
                w = 0,
                E = m || a,
                L = n ? E(d, j) : e || p ? E(d, 0) : void 0;
              j > w;
              w++
            )
              if ((v || w in S) && ((g = O((b = S[w]), w, x)), t))
                if (n) L[w] = g;
                else if (g)
                  switch (t) {
                    case 3:
        ...
        u = (function () {
          function t(n) {
            ...
            !(function (t, n) {
              ...
              (this.lf = r),
              (this.lf.setPatternItems = function (t) {
                e.setPatternItems(t);
              });
          }
          var n, e, o;
            ...
            (e = [
              {
                ...
                value: function (t, n) {
                  var e = this;
                  this.destroy(),
                    this.shapeList && 0 !== this.shapeList.length
                      ? ((this.panelEl = document.createElement("div")),
                        (this.panelEl.className = "lf-dndpanel"),
                        this.shapeList.forEach(function (t) {
                          e.panelEl.appendChild(e.createDndItem(t));
                        }),
                        n.appendChild(this.panelEl),
                        (this.domContainer = n))
                      : (this.domContainer = n);
                },
              },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    ((r.className = "lf-dnd-shape"),
                    t.icon &&
                      (r.style.backgroundImage = "url(".concat(t.icon, ")")),
                    e.appendChild(r),
                    t.label)
                  ) {
                  ...
                  return (
                    (e.onmousedown = function () {
                      t.type &&
                        ...
                        t.callback && t.callback(n.lf, n.domContainer);
                    }),
                    ...
                    (e.oncontextmenu = function (e) {
                      n.lf.graphModel.eventCenter.emit(
